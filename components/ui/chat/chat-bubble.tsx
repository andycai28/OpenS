...
const chatBubbleVariant = cva('flex gap-2 max-w-[75%] items-end relative group', {
  variants: {
    variant: {
      received: 'self-start',
...
const chatBubbleMessageVariants = cva('p-3', {
  variants: {
    variant: {
      ...
      sent: 'bg-primary text-primary-foreground rounded-l-lg rounded-tr-lg whitespace-pre-wrap',
    },
    layout: {
      default: '',
